...
function ContactForm() {
  ...
  useEffect(() => {
    ...
    if (service && messageRef.current) {
      messageRef.current.value = `I'm interested in learning more about ${service}. Please get in touch with me.`
    }
  }, [searchParams])
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-background via-background to-background overflow-hidden">
      ...
      <main className="relative z-10 pt-40 pb-20 px-6">
        <Suspense fallback={<div className="max-w-2xl mx-auto text-center text-gray-400">Loading...</div>}>
          <ContactForm />
        </Suspense>
      </main>
    </div>

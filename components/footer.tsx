                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-4 flex flex-row flex-wrap gap-3">
                            <div className="flex items-center gap-3 glass px-4 py-2 rounded-xl w-fit border-white/5">
                                ...
                                <span className="text-[10px] font-bold text-white/70 uppercase tracking-widest">Meta Verified</span>
                            </div>
                            <div className="flex items-center gap-3 glass px-4 py-2 rounded-xl w-fit border-white/5">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-bold text-white/70 uppercase tracking-widest">Google Ads</span>
                                    <span className="text-[8px] text-white/40 uppercase tracking-tight -mt-1">Verified Merchant</span>
                                </div>
                            </div>
                        </div>
                    </div>
